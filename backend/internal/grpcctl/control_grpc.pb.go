...
const (
	ControlPlane_Connect_FullMethodName = "/control.ControlPlane/Connect"
)
...
type ControlPlaneClient interface {
	Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WorkerMessage, MasterCommand], error)
}
...
func (c *controlPlaneClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WorkerMessage, MasterCommand], error) {
...
type ControlPlane_ConnectClient = grpc.BidiStreamingClient[WorkerMessage, MasterCommand]
...
type ControlPlaneServer interface {
	Connect(grpc.BidiStreamingServer[WorkerMessage, MasterCommand]) error
...
func (UnimplementedControlPlaneServer) Connect(grpc.BidiStreamingServer[WorkerMessage, MasterCommand]) error {
...
func _ControlPlane_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ControlPlaneServer).Connect(&grpc.GenericServerStream[WorkerMessage, MasterCommand]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ControlPlane_ConnectServer = grpc.BidiStreamingServer[WorkerMessage, MasterCommand]
